...
export default {
  ...
  children: [{
    ...
    {
      path: '/operatingCenter/activity/invite',
      name: 'activityInvite',
      component: RouteView,
      redirect: '/operatingCenter/activity/invite/index',
      meta: {
        title: '美好红包'
      },
      children: [{
    ...
    },
    {
      ...
      name: 'lotteryIndex',
      component: () => import(/* webpackChunkName: "activity" */ '@/views/operatingCenter/activity/lottery/index'),
      meta: {
        title: '转盘抽奖'
      }
    },
