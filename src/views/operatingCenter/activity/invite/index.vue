          ...
          <a-row>
            <a-col span="8">
              <detail-info
                title="邀请分享"
                :value="
                  `${statisticsInfo.inviter_num ||
                    0}人　${statisticsInfo.share_num || 0}次`
                "
              >
            ...
            <a-col span="8">
              <detail-info
                title="下载登录"
                :value="`${statisticsInfo.download_num || 0}人`"
              ></detail-info>
            </a-col>
            <a-col span="8">
              <detail-info
        ...
        <a-col span="7">
          <a-row>
            <a-col span="12">
              <detail-info
                title="邀请人获得"
                :value="`${statisticsInfo.inviter_credits || 0}币`"
              >
              </detail-info>
            </a-col>
            <a-col span="12">
        ...
        <a-col span="7">
          <a-row>
            <a-col span="8">
              <detail-info
                title="下载率"
                :value="`${statisticsInfo.download_rate || 0}%`"
              >
                <template v-slot:tooltip>
            ...
            <a-col span="8">
              <detail-info
                title="认证率"
                :value="`${statisticsInfo.attestation_rate || 0}%`"
              >
                <template v-slot:tooltip>
            ...
            <a-col span="8">
              <detail-info
                title="裂变层级"
                :value="`${statisticsInfo.fission_level || 0}`"
              >
                <template v-slot:tooltip>
                  <div>最高裂变层级</div>
                </template>
